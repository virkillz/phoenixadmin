defmodule PhoenixadminWeb.UserControllerTest do
  use PhoenixadminWeb.ConnCase

  alias Phoenixadmin.Account

  @create_attrs %{avatar: "some avatar", bio: "some bio", email: "some email", fullname: "some fullname", is_active: true, location: "some location", mobile: "some mobile", password: "some password", password_hash: "some password_hash", role: "some role", username: "some username"}
